  ...
  return (
    ...
    >
      ...
      >
          ...
          <ListItem button className={classes2.link} component={"a"} href={process.env.NODE_ENV === 'production' ? window.location.origin + '/api-docs' : 'http://localhost:8080/api-docs'} target={"_blank"}>
          <ListItemIcon
          className={classNames(classes2.linkIcon)}
                  >
          <DocumentationIcon />
                  </ListItemIcon>
          <ListItemText

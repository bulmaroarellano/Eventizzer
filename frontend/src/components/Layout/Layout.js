...
import VacanciesFormPage from 'pages/CRUD/Vacancies/form/VacanciesFormPage';
import VacanciesTablePage from 'pages/CRUD/Vacancies/table/VacanciesTablePage';
import VacanciesViewPage from 'pages/CRUD/Vacancies/page/VacanciesViewPage';
      ...
      >
        ...
        <Switch>
          ...
          <Route
            ...
            exact
            component={VacanciesTablePage}
          />
          <Route
            path={'/admin/vacancies/new'}
            exact
            component={VacanciesFormPage}
          />
          <Route
